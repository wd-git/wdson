				...
				<div class ="text-center"> 
					<ul class="pagination">
						<c:if test="${pageMaker.prev}">
							<li><a href="${path}/listPaging?page=${pageMaker.makeQuery(pageMaker.startPage-1)}">이전</a></li>
						</c:if>
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li>
							<c:if test="${pageMaker.paging.page == idx}">
							<li class="active"></c:if>
							<a href="${path}/listPaging${pageMaker.makeQuery(idx)}">${idx}</a>
							</li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
							<li><a href="${path}/listPaging?${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if>
					</ul>
				</div>
